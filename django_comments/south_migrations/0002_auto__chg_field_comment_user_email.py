...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Comment.user_email'
        db.alter_column('django_comments', 'user_email', self.gf('django.db.models.fields.EmailField')(max_length=254))

    def backwards(self, orm):

        # Changing field 'Comment.user_email'
        db.alter_column('django_comments', 'user_email', self.gf('django.db.models.fields.EmailField')(max_length=75))
